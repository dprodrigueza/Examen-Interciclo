    ...
    <table style="width:100%" border>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "   <td ><a  href='mod.php?codigo=" . $row['prod_id'] . "&mail=" . $_GET['mail'] . "'>MODIFICAR<a/></td>";
                echo "   <td ><a  href='eliminar_productos.php?codigo=" . $row['prod_id'] . "&mail=" . $_GET['mail'] . "'>ELIMINAR<a/></td>";
                echo "</tr>";
            }
        } else {
            echo "<tr>";
