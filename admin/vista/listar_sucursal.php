    ...
    <table style="width:100%" border>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "   <td ><a  href='modificar_sucursal.php?codigo=" . $row['suc_id'] . "&mail=" . $_GET['mail'] . "'>MODIFICAR<a/></td>";
                echo "   <td ><a  href='../../controladores/controlador_eliminarsuc.php?codigo=" . $row['suc_id'] . "&mail=" . $_GET['mail'] . "'>ELIMINAR<a/></td>";
                echo "</tr>";
            }
        } else {
            echo "<tr>";
