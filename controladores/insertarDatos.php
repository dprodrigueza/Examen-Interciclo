...
if ($conn->query($mail) === TRUE) {
    ...
    $sql = "INSERT INTO usuarios (usu_id, usu_nombre, usu_apellido, usu_mail, usu_constrasena, usu_direccion, usu_rol, usu_foto, usu_del) VALUES ('$cod', '$nombre', '$apellido', '$email', '$contrasena', '' ,'USER', 'user.png', 'N');";
